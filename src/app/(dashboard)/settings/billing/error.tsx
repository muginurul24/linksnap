...
export default function BillingError({
  ...
  useEffect(() => {
    logger.error("billing_page_error_boundary", {
      digest: error.digest,
  ...
  return (
    <div className="flex flex-col items-center gap-4 rounded-lg border bg-card p-8 text-center">
      ...
      <div>
        <p className="text-sm font-medium">Billing is temporarily unavailable</p>
        <p className="mt-1 max-w-md text-sm text-muted-foreground">
          We could not load your plan or payment history. Try again, or return
          to settings while we recover this view.
        </p>
      </div>
